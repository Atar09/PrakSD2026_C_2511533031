...
import java.util.*;
public class DaftarKata_2511533031 {
	private final ArrayList<String> data;
	// Konstruktor: inisialisasi list kosong
	public DaftarKata_2511533031() {
		this.data = new ArrayList<>();
	}
	/** Menambahkan elemen di akhir list. */
	public void tambah_2511533031(String elemen) {
		data.add(elemen);
	}
	// Menambahkan elemen pada indeks tertentu (menyisipkan).
	public void tambahPada_2511533031(int index, String elemen) {
	 ...
	 */
	public void ubahElemen_2511533031(int index, String nilaiBaru) {
		data.set(index,  nilaiBaru);
	}
	/**
	 * Menghapus elemen pada posisi 'index' dan menghilangkan nilai yang dihaps
	 */
	public String hapusElemen_2511533031(int index) {
	 ...
	 */
	public void iterasiCetak_2511533031() {
